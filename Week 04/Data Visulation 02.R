...
df1 <- mtcars[, "drat"] 
#mpg:miles per gallon; cyl: cylinder; wt: weight
...
#color code: http://www.sthda.com/english/wiki/colors-in-r
...
d0<-read.csv('C:\Users\txs401\Dropbox (UFL)\UTSA-2022Fall\UTSA-Urban Planning Methods\Week 04/city_summary_impact.csv')
install.packages("data.table")

library(data.table)

d1<-fread('C:/Users/txs401/Dropbox (UFL)/UTSA-2022Fall/UTSA-Urban Planning Methods/Week 04/Lab04/city_summary_impact.csv')
